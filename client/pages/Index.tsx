  ...
  return (
    <div className="flex h-screen bg-dark-bg text-white overflow-hidden relative">
      ...
      <div
        ...
        } w-56 border-r border-gray-800/50 flex flex-col bg-dark-bg backdrop-blur-sm sticky top-0 h-screen animate-fadeIn fixed md:relative z-40 transition-transform duration-300 md:transition-none md:translate-x-0`}
      >
      ...
      <div className="flex-1 md:max-w-2xl border-r border-gray-800/50 flex flex-col w-screen md:w-auto">
        {/* Header */}
