  ...
  return (
    <div className="flex h-screen w-screen bg-dark-bg text-white overflow-hidden relative">
      ...
      <div
        ...
        } md:translate-x-0 w-56 border-r border-gray-800/50 flex flex-col bg-dark-bg backdrop-blur-sm h-screen animate-fadeIn absolute md:relative md:sticky top-0 z-40 transition-transform duration-300 md:transition-none`}
      >
      ...
      <div className="flex-1 md:max-w-2xl md:border-r border-gray-800/50 flex flex-col w-full">
        {/* Header */}
