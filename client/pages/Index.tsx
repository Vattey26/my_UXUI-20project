  ...
  return (
    <div className="flex h-screen bg-dark-bg text-white overflow-hidden relative">
      ...
      <div
        ...
        } hidden md:flex md:translate-x-0 w-56 border-r border-gray-800/50 flex-col bg-dark-bg backdrop-blur-sm sticky top-0 h-screen animate-fadeIn fixed md:relative z-40 transition-transform duration-300 md:transition-none`}
      >
      ...
      <div className="flex-1 md:max-w-2xl border-r border-gray-800/50 flex flex-col w-full">
        {/* Header */}
